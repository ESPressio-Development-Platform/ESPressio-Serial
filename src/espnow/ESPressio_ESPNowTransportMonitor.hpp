 ...
 * Inherited Memory Total: sizeof(ESPressio::ESPNow::IESPNowTransportObserver) [0 bytes dynamic allocation]
 * Members:
 ...
 * Total Memory: sizeof(ESPressio::ESPNow::IESPNowTransportObserver) + 4 bytes known members + sizeof(ESPressio::Observable::ObserverHandlePtr) [0 bytes dynamic allocation]
