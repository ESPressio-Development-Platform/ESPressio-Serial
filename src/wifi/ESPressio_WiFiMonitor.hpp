 ...
 * Inherited Memory Total: sizeof(ESPressio::WiFi::IWiFiObserver) [0 bytes dynamic allocation]
 * Members:
 ...
 * Total Memory: sizeof(ESPressio::WiFi::IWiFiObserver) + 4 bytes known members + sizeof(ESPressio::Observable::ObserverHandlePtr) [0 bytes dynamic allocation]
