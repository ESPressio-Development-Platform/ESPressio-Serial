 ...
 * Inherited Memory Total: sizeof(ESPressio::Security::ITransportSecurityObserver) [0 bytes dynamic allocation]
 * Members:
 ...
 * Total Memory: sizeof(ESPressio::Security::ITransportSecurityObserver) + 4 bytes known members + sizeof(ESPressio::Observable::ObserverHandlePtr) [0 bytes dynamic allocation]
